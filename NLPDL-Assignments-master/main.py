...
def customized_greedy_decoding(batch):
    ...
    KV_cache = None    # * KV_cache is None for the first iteration
    for timestep in range(MAX_NEW_LENGTH):
        outputs = custom_model(**tokenized_batch, KV_cache=KV_cache)
        ...
        KV_cache = outputs['KV_cache']    # * Update KV_cache for the next iteration
...
if __name__ == "__main__":
    ...
    print("Time taken for custom cache greedy decoding: ", times[1])
